const NewsLetter  = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center mt-24 space-y-2 text-center pb-14">
            ...
            <form className="flex items-center justify-between w-full h-12 max-w-2xl md:h-13">
                <input
                    ...
                    required
                />
                <button type="submit" className="h-full px-8 text-white transition-all rounded-md rounded-l-none cursor-pointer bg-primary md:px-12 hover:bg-indigo-600">
                    Subscribe
                </button>
            </form>
        </div>
