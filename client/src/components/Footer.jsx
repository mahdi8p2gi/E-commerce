...
const Footer = () => {
  return (
    <div className="px-6 mt-24 py-10 md:px-16 lg:px-24 xl:px-32 bg-primary/10">
      <div className="flex flex-col items-start justify-between gap-10 py-10 text-gray-500 border-b md:flex-row border-gray-500/30">
        <div>
          <img className="w-34 md:w-[180px]" src={assets.logo} alt="logo" />
          <p className="max-w-[410px] mt-6 md:text-lg text-base">
        ...
        <div className="flex flex-wrap justify-between w-full md:w-[45%] gap-5">
          {footerLinks.map((section, index) => (
            <div key={index} className="">
              <h3 className="mb-2  md:text-xl font-semibold text-gray-900 md:mb-5">
                {section.title}
              </h3>
