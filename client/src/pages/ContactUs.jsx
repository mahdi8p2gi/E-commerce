...
const ContactUs = () => {
    ...
    return (
        <form className="flex flex-col items-center mt-8 text-sm">
            ...
            <button type="submit" className="mt-5 bg-primary hover:bg-primary-dull text-white h-12 w-56 px-4 rounded active:scale-95 transition">Send Message</button>
        </form>
    );
