...
const NotFound = () => {
    ...
    return (
        <div className="flex flex-col items-center mt-8 justify-center text-sm max-md:px-4">
            ...
            <div className="flex items-center gap-4 mt-6">
                ...
                <a href="/contact-us" className="border border-gray-300 px-7 py-2.5 text-gray-800 rounded-md active:scale-95 transition-all">
                    Contact support
                </a>
            </div>
        </div>
